      ...
      <div className="text-center max-w-5xl w-full">
        ...
        <div className="mb-16">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="py-8 space-y-8 mb-16"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl border border-gray-700 mb-16"
          >
            <h3 className="text-2xl mb-6 text-[#00BFA6] text-center">Career Objective</h3>
            <p className="text-lg text-gray-300 leading-8 text-center">
          ...
          {highlights.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl border border-gray-700 hover:border-[#00BFA6] transition-all min-h-[220px] flex flex-col"
              >
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${item.color} flex items-center justify-center mb-4`}>
                  <Icon className="text-white" size={24} />
                </div>
                <h4 className="text-xl mb-2 text-[#00BFA6] text-center">{item.title}</h4>
                <p className="text-gray-400 text-sm text-center mt-auto">{item.description}</p>
              </motion.div>
            );
          })}
        </div>
